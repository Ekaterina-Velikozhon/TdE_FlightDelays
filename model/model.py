...
class Model:
    ...
    def getCamminoOttimo(self, v0, v1, t):
        ...
        parziale = [v0] #una lista dei nodi
    ...
    def _ricorsione(self, parziale, v1, t):
        ...
        if parziale[-1] == v1: #uguale all'aeroporto di destinazione
        ...
        #Prendo i vicini dell'ultimo nodo del parziale e aggiungo un nodo alla volta
